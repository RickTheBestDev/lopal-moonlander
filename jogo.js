...
function desenharChama(){
    ...
    //determina o tamanho
    contexto.lineTo(0, moduloLunar.altura * 0.5 + Math.random() * 1000)
    contexto.lineTo(moduloLunar.largura * -0.5, moduloLunar.altura * 0.5)
    contexto.closePath()
...
function desenhar(){
    ...
    contexto.save()
    contexto.translate(canvas.width / 2, canvas.heigth / 2)
    contexto.beginPath();
...
function atracaoGravidade(){
    ...
    moduloLunar.velocidade += gravidade
}
desenhar();